                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 12) {
                        RedDestinationOption(icon: "photo.on.rectangle.angled", title: "Camera Roll",
                                             subtitle: "Save photos & videos to Photos app", color: "#FF2020") {
                            dismiss()
                        ...
                        RedDestinationOption(icon: "folder.fill", title: "Files App",
                                             subtitle: "Save to 'Recovered Files' folder", color: "#FF4040") {
                        ...
                        RedDestinationOption(icon: "icloud.and.arrow.up", title: "iCloud Drive",
                                             subtitle: "Sync recovered files to iCloud", color: "#FF6060") {
                            dismiss()
                            DispatchQueue.main.asyncAfter(deadline: .now() + 0.3) {
